...
<div class="page-wrap container">
	<div id="main-content">
		<div class="main-content-wrap clearfix">
			<div id="content">
				<!-- Afiseaza un gand pentru suflet -->
				<?php
					$args = array(
					...
					?>
						...
						<section class="week-article">
							<h1 class="module-title">Reflecția săptămânii</h1>

							<div class="module-content">
								<?php echo get_the_content('') ?>
								<div class="section-buttons clearfix">
									<a href="<?php the_permalink(); ?>" class="read-more"><span>Citește</span></a>
								</div>
							</div> <!-- .module-content -->
						</section>
						<?php endwhile; ?>
...
?>
				<section class="recent-module">
					<h1 class="module-title">Ultimele articole</h1>
					<div class="module-content">
					<?php
						$args = array(
							'ignore_sticky_posts' => 1,
						...
						if ( 'all' !== $module['category'] )
							$args['cat'] = implode(',', $module['category']);
