<div id="system">
	...
	<?php if (have_posts()) : ?>
		...
		<div class="item">
			...
			<p class="meta"><?php printf(__('Published by %s on %s', 'warp'), '<a href="'.get_author_posts_url(get_the_author_meta('ID')).'" title="'.get_the_author().'">'.get_the_author().'</a>', get_the_time('F jS, Y')); ?>.
