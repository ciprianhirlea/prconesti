...
// set module wrapper
if($config->get('modulewrappertop')) $config->set('body-modulewrappertop', 'modulewrappertop');
if($config->get('modulewrapperbottom')) $config->set('body-modulewrapperbottom', 'modulewrapperbottom');
if($config->get('contentwrapper')) $config->set('body-contentwrapper', 'contentwrapper');
